...
import java.util.*;
class SolveFirstThread extends Thread{
    String string;
    SolveFirstThread(String s){
        this.string=s;
    }
    public void run()
    {
...
class SolveSecondThread extends Thread{
    String string;
    SolveSecondThread(String s){
        this.string=s;
    }
    public void run()
    {
...
public class TwoThreads {
    public static void main(String args[]) throws Exception{
        ...
        String s1="Accolite is an innovative, design thinking software company that guarantees " +
        ...
        String s2=" has brought in referrals again and again from our customers. Please take a look at some of our testimonials.The Company aids in organizing classroom sessions seamlessly as well as proctored remote tests with AI/ML integration for preventing people from cheating both for local and global students.\n" +
        ...
        SolveFirstThread obj1=new SolveFirstThread(s1);
        SolveSecondThread obj2=new SolveSecondThread(s2);
        obj1.start();
        obj2.start();
